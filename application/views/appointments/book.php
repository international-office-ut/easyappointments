...
<head>
    ...
    <meta name="theme-color" content="#A51E37">
...
<div id="main" class="container">
    <div class="row wrapper">
        <div id="book-appointment-wizard" class="col-12 col-lg-10 col-xl-8">
            ...
            <!-- FRAME TOP BAR -->
            <div id="company-logo">
              <img src="<?= base_url('assets/img/ut-logo.png') ?>">
            </div>
            <div id="header">
                ...
                <div class="frame-container">
                    ...
                    <div class="row frame-content">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div id="select-timezone" class="form-group">
                                <label for="select-timezone"><?= lang('timezone') ?></label>
                                <?= render_timezone_dropdown('id="select-timezone" class="form-control" disabled="true"'); ?>
                            </div>
                        </div>
                    </div>
                </div>
